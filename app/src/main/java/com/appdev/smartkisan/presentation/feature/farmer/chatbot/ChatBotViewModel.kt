...
import com.appdev.smartkisan.data.repository.ChatBotRepository
        ...
        viewModelScope.launch {
            try {
                ...
                botChatRepository.saveMessage(
                    message = message,
                    role = com.appdev.smartkisan.domain.model.ChatRoleEnum.USER.value,
                ...
                if (cleanedResponse.isNotEmpty()) {
                    ...
                    botChatRepository.saveMessage(
                        ...
                        role = com.appdev.smartkisan.domain.model.ChatRoleEnum.MODEL.value
