...
sealed interface DiseaseDetectActions {
    ...
    data class NavigateToProductDetail(val product: Product) : DiseaseDetectActions
    ...
    data class FetchProductsForDisease(val diseaseName: String) : DiseaseDetectActions
}