...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userAccessToken = SessionManagement.getAccessToken(this)
        setContent {
            SmartKisanTheme {
                Surface(
                    ...
                    NavGraph(notInitialLaunch, userType, userId, userAccessToken) { token ->
                        SessionManagement.saveAccessToken(this, token)
                    }
                }
            }
        }
