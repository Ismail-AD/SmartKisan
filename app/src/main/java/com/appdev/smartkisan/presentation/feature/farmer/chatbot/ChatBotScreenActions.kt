...
sealed interface ChatBotScreenActions {
    ...
    data object ShowDatePickerDialog :
        ChatBotScreenActions // New action for showing date picker dialog
    data object HideDatePickerDialog :
        ChatBotScreenActions // New action for hiding date picker dialog
    ...
    data class SpeechRecognitionResult(val text: String, val language: String) :
        ChatBotScreenActions
